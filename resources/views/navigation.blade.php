            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo-horizontal class="block h-16 w-auto fill-current text-slate-800 dark:text-slate-200"/>
                    </a>
                </div>
